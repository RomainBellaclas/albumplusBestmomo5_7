...
use App\Repositories\ {
    ImageRepository, NotificationRepository, AlbumRepository, CategoryRepository, TypeCameraRepository,
};
...
class ImageController extends Controller
{
    ...
    public function __construct(
        ...
        TypeCameraRepository $typeCameraRepository)
    {
        $this->imageRepository = $imageRepository;
        $this->albumRepository = $albumRepository;
        $this->categoryRepository = $categoryRepository;
        $this->typeCameraRepository = $typeCameraRepository;
    }
    ...
    public function store(Request $request)
    {
        $request->validate ([
            ...
            'typecamera_id' => 'required|exists:typecamera,id',
            'description' => 'nullable|string|max:255',
        ]);
    ...
    public function typeCamera($slug)
    {
        $typeCamera = $this->typeCameraRepository->getBySlug ($slug);
        $images = $this->imageRepository->getImagesForTypeCamera ($slug);

        return view ('home', compact ('typecamera', 'images'));
    }
