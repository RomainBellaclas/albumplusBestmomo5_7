    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownCat">
                    @foreach($typecamera as $letypecamera)
                        <a class="dropdown-item"
                           href="{{ route('typecamera', $letypecamera->slug) }}">{{ $letypecamera->name }}</a>
                    @endforeach
                </div>
            </li>
            @isset($albums)
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle{{ currentRoute(
                                        ...
                                        route('user.index'),
                                        route('typecamera.create'),
                                        route('typecamera.index'),
                                        route('typecamera.edit', request()->typecamera?: 0)
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownGestCat">
                    ...
                    <a class="dropdown-item" href="{{ route('typecamera.create') }}">
                        <i class="fas fa-plus fa-lg"></i> @lang('Ajouter un type de caméra')
                    </a>
                    <a class="dropdown-item" href="{{ route('typecamera.index') }}">
                        <i class="fas fa-wrench fa-lg"></i> @lang('Gérer les types de caméras')
                    </a>
                </div>
            </li>
            @endadmin
